...
if (!hasWCStyles) {
  const css = `
      ...
      :root {
        --wc-wc-default-font-family: "mabry-regular-pro";
              
        --wc-headline-0-font: 700 12.8rem/1.5 "mabry-regular-pro";
        --wc-headline-1-font: 500 6.4rem/1.5 "mabry-regular-pro";
        --wc-headline-2-font: 500 4.8rem/1.5 "mabry-regular-pro";
        --wc-headline-3-font: 500 3.2rem/1.5 "mabry-regular-pro";
        --wc-headline-4-font: 500 2.4rem/1.5 "mabry-regular-pro";
        --wc-headline-5-font: 500 1.6rem/1.5 "mabry-regular-pro";
        --wc-material-icons-small-font: 2rem/1 "Material Icons";
        --wc-material-icons-medium-font: 2.4rem/1 "Material Icons";
        --wc-material-icons-outlined-medium-font: 2.4rem/1 "Material Icons Outlined";
        --wc-material-icons-large-font: 3.2rem/1 "Material Icons";
        --wc-button-large-font: 500 2.4rem/1.5 "inter";
        --wc-button-arrow-small-font: 1.6rem/1 "mabry-regular-pro";
        --wc-button-arrow-medium-font: 2rem/1 "mabry-regular-pro";
        --wc-button-arrow-large-font: 3.2rem/1 "mabry-regular-pro";
        --wc-paragraph1-regular-font: 2rem/1.5 "inter";
        --wc-paragraph1-medium-font: 500 2rem/1.5 "inter";
        --wc-paragraph1-bold-font: 700 2rem/1.5 "inter";
        --wc-paragraph2-regular-font: 1.8rem/1.4 "inter";
        --wc-paragraph2-medium-font: 500 1.8rem/1.4 "inter";
        --wc-paragraph2-semi-font: 600 1.8rem/1.4 "inter";
        --wc-paragraph2-bold-font: 700 1.8rem/1.4 "inter";
        --wc-paragraph3-regular-font: 1.6rem/1.5 "inter";
        --wc-paragraph3-medium-font: 500 1.6rem/1.5 "inter";
        --wc-paragraph3-bold-font: 700 1.6rem/1.5 "inter";
        --wc-paragraph4-regular-font: 1.4rem/1.5 "inter";
        --wc-paragraph4-medium-font: 500 1.4rem/1.5 "inter";
        --wc-paragraph4-bold-font: 700 1.4rem/1.5 "inter";
        --wc-paragraph5-regular-font: 1.2rem/1.5 "inter";
        --wc-paragraph5-medium-font: 500 1.2rem/1.5 "inter";
        --wc-paragraph5-bold-font: 700 1.2rem/1.5 "inter";
        --wc-input-field-font: 2rem/1.2 "inter";
        --wc-color-base-black: #000;
        --wc-color-base-white: #fff;
        ...
        --wc-color-primary-accent-500: #7d51da;
        --wc-color-primary-accent-400: #e6ddf9;
        --wc-color-secondary-700: #21d3a6;
        --wc-color-secondary-600: #2ee8b9;
        --wc-color-secondary-500: #41ffd1;
        --wc-color-hover-500: #e8ebf0;
        ...
        --wc-color--links-500-Body: #3c4ef1;
        --wc-color-misc-disabled: #07002661;
        ...
        --wc-color-status-info-background: #eceffb;
        ...
        --wc-color-tooltip-background-500: #26293f;
      }
    `;
